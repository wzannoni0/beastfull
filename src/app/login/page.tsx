    ...
    <div className="app-container">
      ...
      <div className="scroll-area">
        ...
        <div className="text-center py-12">
          <h1 className="text-white font-bold text-3xl mb-3 glow-text">Welcome Back</h1>
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center border-2 border-[#0f0820]">
        ...
        <div className="card p-6 mb-6">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="text-purple-400 text-xs font-medium">Forgot?</button>
            </div>
          </div>
        </div>
